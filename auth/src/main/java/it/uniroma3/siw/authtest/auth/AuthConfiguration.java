    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/", "/index","/home","/welcome",
                    		"/fotografi","/guest/fotografo/{idS}",
                    		"/guest/fotografo/{idS}/album/{idA}",
                    		"/photos","/aggiornaCarrello/{idR}/{nome}").permitAll()
                    ...
                    .antMatchers(HttpMethod.GET, "/fotografiAdmin").hasAnyAuthority("ADMIN")
                    
                    .antMatchers(HttpMethod.GET, "/fotografo/{idS}").hasAnyAuthority("ADMIN")
                    .antMatchers(HttpMethod.POST, "/fotografo/{idS}/album").hasAnyAuthority("ADMIN")
                    .antMatchers(HttpMethod.GET, "/fotografo/{idS}/album/{idA}").hasAnyAuthority("ADMIN") 
                    .antMatchers(HttpMethod.GET, "/fotografo/{idS}/album/{idA}/foto/inserita").hasAnyAuthority("ADMIN")
